...
class BaselineTrainLS(nn.Module):
    def __init__(self, model_func, num_class, lam = 0, loss_type = 'softmax'):
        super(BaselineTrainLS, self).__init__()
        ...
        self.loss_fn = LabelSmoothingCrossEntropy(lam = lam)
