...
if __name__ == '__main__':
    ...
    for index, method in enumerate(method_list_regularization):
        ...
        if params.save_iter != -1:
            outfile = os.path.join(checkpoint_dir.replace("checkpoints","ensemble_features"), split + "_" + str(params.save_iter)+ ".hdf5")
        else:
            outfile = os.path.join( checkpoint_dir.replace("checkpoints","ensemble_features"), split + ".hdf5")
