...
ROOT = '/home/lab1211/Data/tiered-imagenet-tools/'
class TieredImageNetDataLoader(object):
    def __init__(self, shot_num, way_num, episode_test_sample_num):
        ...
        metatrain_folder = os.path.join(ROOT, 'tiered_imagenet/train')# './processed_images/train'
        metaval_folder = os.path.join(ROOT, 'tiered_imagenet/val')# './processed_images/val'
        metatest_folder = os.path.join(ROOT, 'tiered_imagenet/test')# './processed_images/test'

        npy_dir = os.path.join(ROOT, './episode_filename_list/')
...
if __name__ == '__main__':
    dataloader = TieredImageNetDataLoader(5, 5, 15)
